...
def hello():
    try:
        ...
        # Bắt ID của Container đang chạy code này
        container_id = socket.gethostname()
        
        return render_template_string(HTML_TEMPLATE, visits=total_visits, hostname=container_id)
    except Exception as e:
        return f"<h1>Hệ thống đang khởi động kết nối DB...</h1><p>Vui lòng F5 lại sau vài giây (Lỗi: {str(e)})</p>"
